...
const EditCategory = ({ match }) => {
  ...
  function handleSubmit(event) {
    ...
    // API Call
    axios
      .put(apiUpdateSceneCategory + match.params.id, {
        title: title,
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`${apiGetSceneCategory + "?id=" + match.params.id}`, {})
      .then(function (response) {
        setTitle(response.data.scene.title);
        setCategoryImage(response.data.scene.categoryImage);
