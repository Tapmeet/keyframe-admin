...
const SceneTwentyFive = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section section-five section-six section-25">
...
export default SceneTwentyFive;
