...
const SceneTwentySix = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-18 scene-26 scene-19 slider-section">
