...
const SceneFiftySeven = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section scene-55 scene-57">
              ...
              {textArrays.map((data, index) => {
                return index == 2 ? (
                  <div
                    ...
                    contenteditable="true"
                    onClick={() => setshowbg(false, "", "", false, 2, 2)}
                    onInput={(e) => getcontent(e.currentTarget.textContent, 2)}
                  >
                    {data.text}
                  </div>
                ) : null;
            ...
            {textArrays.map((data, index) => {
              return index == 3 ? (
                <textarea
                  ...
                  onChange={(e) => getcontent('123 Main Street,\n Somewhere US 12345', 3)}
                  value={data.text}
                >
            ...
            {textArrays.map((data, index) => {
              return index == 4 ? (
                <div
                  ...
                  onInput={(e) => getcontent(e.currentTarget.textContent, 4)}
                >
                  {data.text}
                </div>
              ) : null;
