...
const SceneThirtyFive = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-18 scene-34 scene-35  section-six scene-32 scene-19 slider-section">
...
export default SceneThirtyFive;
