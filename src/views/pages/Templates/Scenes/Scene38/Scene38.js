...
const SceneThirtyEight= (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-18 scene-19 scene-38  scene-21 scene-23 slider-section">
...
export default SceneThirtyEight;
