...
const SceneSixtyNine = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-18 section-six scene-32 scene-34 scene-42  scene-19  scene-69 slider-section">
