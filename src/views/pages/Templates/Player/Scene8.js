    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section3  section-6"
              : " playerui-wrapper  slider-section section3 section-6"
          }
        >
...
export default PlayerSceneEight;
