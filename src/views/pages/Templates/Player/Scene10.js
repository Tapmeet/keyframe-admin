...
const PlayerSceneten = (props) => {
  ...
  React.useEffect(() => {
    ...
    clearTimeout(timeout, activeClassTimer, animation2);
    if (props.index == 0) {
      setSceneActive(true);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section4 scene-10"
              : " playerui-wrapper  slider-section section4scene-10"
          }
        >
          <div className="d-flex">
            <div className="img-section d-flex">
              <div className="half-width player-slider-1">
                {textArrays.map((data, index) => {
                  return index == 0 ? (
                    <DragResizeContainer
