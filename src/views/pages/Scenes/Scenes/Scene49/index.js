...
import SceneFourtyNine from "./Scene49";
...
const TemplateScene49 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=49`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="49" />
      ) : null}
