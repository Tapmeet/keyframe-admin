...
import SceneThirtyEight from "./Scene38"; 
...
const TemplateScene38 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=38`, {}).then(function (response) {
  ...
  React.useEffect(() => {
    if (cookies.get("token")) {
      ...
      setUserId("5fb38662f0b30f2d6c9ff48c");
      getData();
    }
  }, [userId]);
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="38" />
      ) : null}
...
export default TemplateScene38;
