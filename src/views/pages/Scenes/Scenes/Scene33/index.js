...
import SceneThirtyThree from "./Scene33";
...
const TemplateScene33 = (props) => {
  ...
  const [textSize, setTextSize] = React.useState("33");
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=33`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="33" />
      ) : null}
...
export default TemplateScene33;
