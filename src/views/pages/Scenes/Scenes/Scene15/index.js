...
import SceneFifteen from "./Scene15";
...
const TemplateScene15 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=15`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="15" />
      ) : null}
...
export default TemplateScene15;
