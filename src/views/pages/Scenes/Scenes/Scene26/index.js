...
import SceneTwentySix from "./Scene26"; 
...
const TemplateScene26 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=26`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="26" />
      ) : null}
...
export default TemplateScene26;
