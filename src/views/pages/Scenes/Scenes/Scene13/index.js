...
import SceneThirteen from "./Scene13";
...
const TemplateScene13 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=13`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper scene-13">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="13" />
      ) : null}
...
export default TemplateScene13;
