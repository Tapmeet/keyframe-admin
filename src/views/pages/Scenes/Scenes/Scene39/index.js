...
import SceneThirtyNine from "./Scene39";
...
const TemplateScene39 = (props) => {
  ...
  const [textSize, setTextSize] = React.useState("39");
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=39`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="39" />
      ) : null}
...
export default TemplateScene39;
