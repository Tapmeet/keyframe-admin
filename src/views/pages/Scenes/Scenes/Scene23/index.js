...
import SceneTwentyThree from "./Scene23"; 
...
const TemplateScene23 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=23`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="23" />
      ) : null}
...
export default TemplateScene23;
