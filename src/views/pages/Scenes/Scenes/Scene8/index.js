...
const TemplateScene8 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=8`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="8" />
      ) : null}
