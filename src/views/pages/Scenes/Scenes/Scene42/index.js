...
import SceneFourtyTwo from "./Scene42"; 
...
const TemplateScene42 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=42`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="42" />
      ) : null}
...
export default TemplateScene42;
