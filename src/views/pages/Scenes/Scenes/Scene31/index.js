...
import SceneThirtyOne from "./Scene31"; 
...
const TemplateScene31 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=31`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="31" />
      ) : null}
...
export default TemplateScene31;
