...
import SceneFourtyThree from "./Scene43";
...
const TemplateScene43 = (props) => {
  ...
  const [textSize, setTextSize] = React.useState("43");
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=43`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="43" />
      ) : null}
...
export default TemplateScene43;
