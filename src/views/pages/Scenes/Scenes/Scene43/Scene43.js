...
const SceneFourtyThree = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 section-18 slider-section section-43 section-39 ">
...
export default SceneFourtyThree;
