...
const TemplateNew37 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=37`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="37" />
      ) : null}
