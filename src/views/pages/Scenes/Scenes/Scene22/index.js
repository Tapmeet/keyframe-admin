...
import SceneTwentyTwo from "./Scene22";
...
const TemplateScene22 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=22`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="22" />
      ) : null}
...
export default TemplateScene22;
