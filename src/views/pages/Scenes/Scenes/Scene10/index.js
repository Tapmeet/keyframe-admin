...
const TemplateScene10 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=10`, {}).then(function (response) {
...
export default TemplateScene10;
