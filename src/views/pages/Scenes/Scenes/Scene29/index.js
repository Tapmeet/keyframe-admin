...
import SceneTwentyNine from "./Scene29";
...
const TemplateScene29= (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=29`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper scene-seven">
      {templateTitle ? (
        <TopSection
...
export default TemplateScene29;
