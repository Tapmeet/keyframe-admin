...
import SceneFourtyOne from "./Scene41"; 
...
const TemplateScene41 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=41`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="41" />
      ) : null}
...
export default TemplateScene41;
