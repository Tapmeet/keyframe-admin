...
const SceneFourtyOne = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-18 scene-40 scene-41 scene-19 slider-section">
