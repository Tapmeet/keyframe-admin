...
import SceneThirtyFour from "./Scene34"; 
...
const TemplateScene34 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=34`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="34" />
      ) : null}
...
export default TemplateScene34;
