...
import SceneSixteen from "./Scene16"; 
...
const TemplateScene16 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=16`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="16" />
      ) : null}
...
export default TemplateScene16;
