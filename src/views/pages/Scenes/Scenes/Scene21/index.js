...
import SceneTwentyOne from "./Scene21"; 
...
const TemplateScene21 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=21`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="21" />
      ) : null}
...
export default TemplateScene21;
