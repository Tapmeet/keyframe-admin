...
const TemplateScene27 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=27`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper scene-27">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="27" />
      ) : null}
