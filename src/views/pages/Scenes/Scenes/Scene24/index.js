...
import SceneTwentyFour from "./Scene24"; 
...
const TemplateScene24 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=24`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="24" />
      ) : null}
...
export default TemplateScene24;
