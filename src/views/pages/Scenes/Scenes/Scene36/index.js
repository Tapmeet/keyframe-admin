...
import SceneThirtySix from "./Scene36"; 
...
const TemplateScene36 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=36`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="36" />
      ) : null}
...
export default TemplateScene36;
