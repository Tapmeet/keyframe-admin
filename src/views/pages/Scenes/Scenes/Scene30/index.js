...
import SceneThirty from "./Scene30"; 
...
const TemplateScene30 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=30`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="30" />
      ) : null}
...
export default TemplateScene30;
