...
import SceneEighteen from "./Scene18";
...
const TemplateScene18 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=18`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="18" />
      ) : null}
...
export default TemplateScene18;
