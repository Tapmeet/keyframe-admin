...
import SceneTwelve from "./Scene12";
...
const TemplateScene12 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=12`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="12" />
      ) : null}
...
export default TemplateScene12;
