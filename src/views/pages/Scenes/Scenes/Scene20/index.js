...
import SceneTwenty from "./Scene20"; 
...
const TemplateScene20 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=20`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="20" />
      ) : null}
...
export default TemplateScene20;
