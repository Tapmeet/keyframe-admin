...
const SceneSixtyFive = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section scene-55 scene-58 scene-59 scene-65">
      <div className="d-flex">
        <div className="img-section d-flex">
          ...
          {mediaArray.map((data, index) => {
            return index == 2 ? (
              <div className="box-1 box-size" onClick={() =>
                setshowbg(true, data.url, data.type, false, index)
              }
                style={{
                  "background-image": "url(" + apiPath + data.url + ") ",
                ...
                onInput={(e) => getcontent('4br 3ba', 3)}>4br 3ba  </div> */}
                </div>
              </div>
            ) : null;
          })}
