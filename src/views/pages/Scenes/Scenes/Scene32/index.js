...
const TemplateScene32 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=32`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="32" />
      ) : null}
...
export default TemplateScene32;
