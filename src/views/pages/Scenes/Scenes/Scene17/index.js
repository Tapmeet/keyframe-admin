...
import SceneSevenTeen from "./Scene17"; 
...
const TemplateScene17 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=17`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="17" />
      ) : null}
...
export default TemplateScene17;
