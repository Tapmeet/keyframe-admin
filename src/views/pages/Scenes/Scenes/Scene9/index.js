...
const TemplateScene9 = (props) => {
  ...
  function getData() {
    axios.get(`${apiGetScene}?id=9`, {}).then(function (response) {
  ...
  return (
    <section className="template-new-wrapper scene-warpper">
      {templateTitle ? (
        <TopSection templateTitle={templateTitle} id="9" />
      ) : null}
