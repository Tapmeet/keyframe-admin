    ...
    <section className="template-new-wrapper-text-editor">
      <div className="text-editor">
        ...
        <div className="sectionOne">
          <FontPicker
            families={
              "Arimo, Lato, Montserrat,DM Serif Display , Noto Serif,Raleway, Teko,Oswald, Merriweather ,Roboto, Josefin Sans, Barlow, Open Sans, Poppins, Hurricane, Inspiration, Cairo, Saira Condensed, Asap"
            }
