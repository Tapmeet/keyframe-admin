...
const routes = [
  ...
  { path: '/template/:id/59/:sceneid', exact: true, name: 'Scene 58', component: TemplateSceneFiftyNine },
  { path: '/template/:id/60/:sceneid', exact: true, name: 'Scene 58', component: TemplateSceneSixty },
